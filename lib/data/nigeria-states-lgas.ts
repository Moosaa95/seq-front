...
export const NIGERIA_STATES: StateData[] = [
    ...
    {
        name: 'FCT - Abuja',
        lgas: ['Abaji', 'Abuja Municipal Area Council (AMAC)', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali'],
    },
    {
        name: 'Gombe',
    ...
    {
        name: 'Yobe',
        lgas: ['Bade', 'Bursari', 'Damaturu', 'Fika', 'Fune', 'Geidam', 'Gujba', 'Gulani', 'Jakusko', 'Karasuwa', 'Machina', 'Nangere', 'Nguru', 'Potiskum', 'Tarmua', 'Tarmuwa', 'Yunusari'],
    },
    {
        name: 'Zamfara',
